...
export function renderWiki(container) {
  ...
  container.innerHTML = `
    ...
    <section class="wiki-section">
      ...
      <div class="wiki-grid">
        <article class="wiki-card"><h4>How to read them</h4><p>The two shapes are never the same. Their arrangement carries the semantic meaning. More-sided vs fewer-sided shape determines Contains vs Inside, Greater vs Less, and Leads to vs Follows.</p></article>
